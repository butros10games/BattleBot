...
MOTOR1_FOR_request = gpiod.request_lines(
    "/dev/gpiochip4",
    consumer="blink-example",
    config={
        MOTOR1_FOR: gpiod.LineSettings(
            direction=Direction.OUTPUT, output_value=Value.ACTIVE
        )
    },
)
MOTOR1_BACK_request = gpiod.request_lines(
    "/dev/gpiochip4",
    consumer="blink-example",
    config={
        MOTOR1_BACK: gpiod.LineSettings(
            direction=Direction.OUTPUT, output_value=Value.ACTIVE
        )
    },
)
MOTOR2_FOR_request = gpiod.request_lines(
    "/dev/gpiochip4",
    consumer="blink-example",
    config={
        MOTOR2_FOR: gpiod.LineSettings(
            direction=Direction.OUTPUT, output_value=Value.ACTIVE
        )
    },
)
MOTOR2_BACK_request = gpiod.request_lines(
    "/dev/gpiochip4",
    consumer="blink-example",
    config={
        MOTOR2_BACK: gpiod.LineSettings(
            direction=Direction.OUTPUT, output_value=Value.ACTIVE
        )
    },
)
MOTOR1_PWM_request = gpiod.request_lines(
    "/dev/gpiochip4",
    consumer="blink-example",
    config={
        PWM1_PIN: gpiod.LineSettings(
            direction=Direction.OUTPUT, output_value=Value.ACTIVE
        )
    },
)
MOTOR2_PWM_request = gpiod.request_lines(
    "/dev/gpiochip4",
    consumer="blink-example",
    config={
        PWM2_PIN: gpiod.LineSettings(
            direction=Direction.OUTPUT, output_value=Value.ACTIVE
        )
    },
)
...
try:
    ...
    set_motor_direction(
        MOTOR1_FOR_request, MOTOR1_BACK_request, MOTOR1_FOR, MOTOR1_BACK, "forward"
    )
    ...
    set_motor_direction(
        MOTOR2_FOR_request, MOTOR2_BACK_request, MOTOR2_FOR, MOTOR2_BACK, "backward"
    )
